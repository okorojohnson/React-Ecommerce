...
It is recommended to use as a sleeping place for guests, not intended for daily use as a bed."
      />
      <Accordion title="Sizes" content="" />
      <Accordion title="Care Instructions" content="" />
      <Accordion title="Quality and environmental information" content="" />
      <Accordion title="Packing Information" content="" />
      <Accordion title="Instructions and documents" content="" />
      <Accordion title="Product Availability" content="" />
      <Accordion title="Reviews" content="" />
    </div>
  );
};
